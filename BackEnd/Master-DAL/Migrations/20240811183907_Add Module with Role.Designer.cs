...
namespace Master_DAL.Migrations
{
    ...
    [Migration("20240811183907_Add Module with Role")]
    partial class AddModulewithRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Master_DAL.Models.Menu", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Master_DAL.Models.Menu", b =>
                {
                    b.HasOne("Master_DAL.Models.SubModules", "SubModules")
                        .WithMany("Menu")
