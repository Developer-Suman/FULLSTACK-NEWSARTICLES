...
namespace MASTER_PROJECT_IN_LAYERED_ARCHITECTURE_GENERIC_REPOSITORY.Controllers
{
    ...
    public class CommentsController : MasterProjectControllerBase
    {
        ...
        public CommentsController(ICommentsRepository commentsRepository, IMemoryCacheRepository memoryCacheRepository, UserManager<ApplicationUser> userManager, IMapper mapper, RoleManager<IdentityRole> roleManager) : base(userManager, mapper, roleManager)
        {
